...
namespace DelLab03
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            mySecondDel(first);
            mySecondDel = first.PrintLastName;
            mySecondDel(first);
            mySecondDel = first.PrintState;
            mySecondDel(first);
            mySecondDel = first.PrintParty;
            mySecondDel(first);
            mySecondDel = first.PrintYear;
            mySecondDel(first);
        }
    }
    public class President
    {
        ...
        public void PrintFirstName(President p) => Console.WriteLine(p.FirstName); // Expression, body, method
